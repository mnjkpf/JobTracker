...
/**
 * Redis-кеш для LLM-відповідей. Extraction — детермінована операція, тому
 * кешуємо і не платимо за повторні виклики (критично під час розробки).
 * <p>
 * Ключ = "ai:extract:" + SHA-256(input).
 */
@Component
